...
import {InventorySlot, IgtFeature, AbstractItem, EmptyItem, AbstractConsumable, ItemAmount, InventorySaveData, InventorySlotSaveData} from "incremental-game-template";
